...
class SubjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subject" do
    assert_difference('Subject.count') do
      post subjects_url, params: { subject: { name: @subject.name, topic_id: @subject.topic_id } }
    end
  ...
  test "should update subject" do
    patch subject_url(@subject), params: { subject: { name: @subject.name, topic_id: @subject.topic_id } }
