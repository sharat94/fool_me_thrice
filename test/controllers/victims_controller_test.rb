...
class VictimsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create victim" do
    assert_difference('Victim.count') do
      post victims_url, params: { victim: { name: @victim.name, topic_id: @victim.topic_id } }
    end
  ...
  test "should update victim" do
    patch victim_url(@victim), params: { victim: { name: @victim.name, topic_id: @victim.topic_id } }
